...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Master Data Unit</h1>
    </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="unit-table" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th width="100">No</th>
                                    <th>Position</th>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function editItem(id) {
            window.location.href = '/unit/' + id + '/edit';
        }
